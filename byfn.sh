...
function networkDown() {
  # stop org3 containers also in addition to org1 and org2, in case we were running sample to add org3 #-f $COMPOSE_FILE_ORG3
...
# Using docker-compose-cli-template.yaml, replace constants with private key file names
...
function replacePrivateKey() {
  ...
  cp docker-compose-cli-template.yaml docker-compose-cli.yaml -f
